...
<GradeChart size="clamp(120px, 16vw, 180px)" items={[
...
## Language Support
::sub[Course materials and submission language]

- Course materials are provided in:
  - Korean (main)
  - English
  - Simplified Chinese
- Need another language? Email tkl@yonsei.ac.kr.
- Assignments, the individual project, and exam answers must be written in one of:
  - Korean
  - English
...
- Past that, each extra unit missed costs **0.25 points** off your attendance grade.
- If you'd rather not be bound by attendance, a **15-minute presentation** earns
  full attendance credit. Any computer-related topic works, AI included.
...
::sub[By the Sep 9 class]

1. Make a **GitHub account** and create your own repository from `algorithm-env`.
2. Run the course examples in a **Codespace** created on `algorithm-code`.
