...
::sub[In `301 - 192` the tidying spreads one place further]
...
The tens digit becomes $$-10$$ and reaches into the hundreds **again**.  
The dependency the subtraction removed returns during the tidying.
