...
실습은 `algorithm-code` 저장소에서 **Use this template**으로 내 저장소를 만들고,
거기서 **Code → Codespaces → Create codespace**를 누르는 것으로 시작합니다. 브라우저에 컴파일러와 Python이 준비된 VS Code가
뜹니다. 설치할 것은 없고 GitHub 계정만 있으면 됩니다.
