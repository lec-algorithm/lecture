---
title: About
description: Advanced Algorithms (SIT2001-01), Fall 2026 — course overview, grading and repositories
order: 1
---
...
| Room | I-B202 |
| Instructor | Taekyu Lee, School of Integrated Technology |
| Grading | Absolute |
| Online | LearnUs |
...
flowchart LR
    ...
    ORG --> C("algorithm-code<br/>practice code (C · Python)")
...
| `algorithm-code` | Pseudocode, C and Python per topic | You make your own copy and run it |
| `algorithm-viz` | Algorithm visualizations | You watch them inside the slides |

Start by pressing **Use this template** on `algorithm-code` to make your own
repository, then open **Code → Codespaces → Create codespace** there. Nothing
to install; a GitHub account is enough.
